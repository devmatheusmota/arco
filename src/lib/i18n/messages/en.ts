export const en = {
  ...
  'onboarding.gitSubtitle':
    'Show repository changes, stage files, and create commits without leaving Arco.',
  ...
  'profiles.backupFileType': 'Arco account backup',
  ...
  'remote.description': 'Scan this QR code from a phone on the same network to open Arco Remote.',
  ...
  'agentInstall.uninstallConfirm':
    'This removes {agent} from this machine. Arco will run the command below in a shell:',
  ...
  'handoff.privacy':
    'The packet stays in your local Arco profile and is deleted after the destination agent completes its first turn.',
  'handoff.lossPrivate':
  ...
  'remote.startupNote':
    'Remote control never starts on its own. Arco only opens the LAN listener while this setting is on.',
  ...
  'remote.settingsStatusDesc':
    'Control whether Arco accepts remote connections on the local network.',
  ...
  'prefs.categoryAccountDesc': 'Manage your local profile, language, and Arco accounts.',
  ...
  'prefs.categoryIntegrationsDesc': 'Connect external services and control what Arco shares.',
  'prefs.categoryUpdates': 'Updates',
  'prefs.categoryUpdatesDesc': 'Check your installed version and look for Arco updates.',
  ...
  'prefs.uiThemeDesc': 'Choose the palette used throughout the Arco interface.',
  ...
  'prefs.windowOpacityDesc': 'Let the desktop show through the entire Arco window.',
  ...
  'prefs.featuresDesc': 'Choose which optional modules are visible in Arco.',
  ...
  'todo.dragPosition': 'Reorder task, position {position} of {total}',
  ...
  'todo.notes': 'Notes',
  'todo.notesPlaceholder': 'Context, acceptance criteria, links — the agent reads this too.',
  'todo.notesIndicator': 'Has notes',
  'todo.expand': 'Show task details',
  'todo.collapse': 'Hide task details',
  ...
  'taskSession.forTask': 'Task',
  'taskSession.project': 'Project',
  'taskSession.pickProject': 'Select a project…',
  'taskSession.agent': 'Agent',
  'taskSession.prompt': 'First message',
  'taskSession.promptHint':
    'Sent to the agent as soon as the session is ready. Built from the task title, tags and notes.',
  'taskSession.folder': 'Folder',
  'taskSession.folderPlaceholder': "The project's default folder",
  'taskSession.browse': 'Browse',
  ...
  'prefs.shortcutRecordLabel': 'Record shortcut',
  'prefs.shortcutRecording': 'Press a key…',
  'prefs.dictationShortcut': 'Shortcut',
  'prefs.dictationShortcutDesc': 'Click and press the chord you want. Esc cancels.',
  'prefs.dictationModel': 'Speech model',
  'prefs.dictationModelDesc': 'Runs on this machine. Nothing is sent anywhere.',
  'prefs.modelDownload': 'Download',
  'prefs.modelUse': 'Use',
  'prefs.modelActive': 'In use',
  ...
  'prefs.dictationModeDesc':
    'Hold: dictate while Ctrl+E is held. Toggle: press Ctrl+E once to start, again to stop.',
  ...
  'prefs.resourcePolicyManualHint':
    'Arco only measures usage. It never closes tabs, parks runtimes or pauses new spawns automatically.',
  ...
  'prefs.cliPathsDesc':
    'Arco finds each agent CLI on its own. Override it only when the CLI lives somewhere unusual — and point it at the command-line tool, not at a desktop app.',
  ...
  'prefs.cliCommandDesc':
    "Install the 'arco' command so you can open any folder as a project straight from the terminal.",
  ...
  'prefs.discordPresenceHint': 'Shows that you are using Arco without exposing project names.',
  ...
  'prefs.upToDate': 'Arco is up to date.',
  ...
  'whatsNew.subtitle': 'Arco keeps getting sharper.',
  ...
  'whatsNew.v130.note8': 'Experimental window opacity control, to see the desktop through Arco.',
  ...
  'home.quickLaunching': 'Opening agent…',
  'home.quickLaunchFailed': 'Could not open the agent:',
  ...
  'term.openingAgent': 'Opening…',
  'term.openAgentFailed': 'Could not open the agent:',
  ...
  'browser.resourceModeAppFirst': 'Prioritize Arco',
  ...
  'browser.resourceModeDescription.keep-alive':
    'Keeps hidden pages loaded, but still releases them if Arco detects memory pressure.',
  'browser.addToGrid': 'Add to grid',
  'browser.privateTitle': 'Private session is always on',
  'browser.privateDescription':
    'Arco opens this pane in a native incognito webview. Cookies, logins, cache, autofill, and site storage are not kept after the pane closes.',
  'browser.privateBadge': 'Private',
  'browser.destination': 'This browser will be added to {project}.',
  'browser.embedHint': 'Opens inside Arco. Some sites may block embedded viewing.',
  ...
  'appClose.title': 'Close Arco?',
  'appClose.message':
    'Open agents and terminals will be stopped. Saved conversations can be resumed the next time you open Arco.',
  'appClose.confirm': 'Close Arco',
  'appClose.cancel': 'Cancel',
  'appClose.failedTitle': 'Arco could not close',
  'appClose.failedBody': 'The close request failed. Try again or open the logs for details.',
  'ui.workspace.openInTab': 'Open in its own tab',
  ...
  'ui.imageInput.previewAlt': 'Icon preview',
  ...
  'ui.sidebar.designWorkspaceLayout': 'Design the layout of this project',
  ...
  'ws.tabs.close': 'Close session',
  'ws.tabs.confirmClose': 'Close "{name}"? Anything running in it stops.',
  'ws.tabs.openSideTerminal': 'Open a terminal beside this session',
  'ws.tabs.closeSideTerminal': 'Close the terminal beside this session',
  ...
  'ws.confirmOverwriteForeignAgent':
    'An agent "{name}" that was NOT created by Arco already exists in this project. Overwrite?',
  'ws.confirmRemoveAgent': 'Remove the agent "{name}" from the project?',
  'ws.confirmRemoveForeignAgent': 'The agent "{name}" was NOT created by Arco. Remove it anyway?',
  ...
  /* ---- crash watch ---- */
  'crash.uncleanTitle': 'Arco closed unexpectedly',
  ...
  'update.checkFailedBody':
    'Arco could not reach the update service. Check your connection and try again.',
  ...
  'prefs.aboutVersionDesc': 'The Arco build currently installed.',
  'prefs.aboutUpdatesTitle': 'Updates',
  'prefs.aboutUpdatesDesc': 'Check for and install new versions of Arco.',
  ...
  'update.checkSuccessTitle': 'Arco is up to date',
  ...
  'resource.warning.body': 'Arco is using about {total} MB. Hidden idle runtimes may be parked.',
  'resource.critical.title': 'Memory budget reached',
  'resource.critical.body':
    'Arco is using about {total} MB. New runtimes are paused until memory recovers.',
  ...
  'sandbox.subtitle':
    'A real planner-to-worker POC: Claude Code plans, Codex implements, and Arco relays the handoff.',
  ...
  'mcp.errJsonc': 'Arco does not write opencode.jsonc, to avoid stripping your comments.',
  ...
  'onboarding.mcpSubtitle':
    'Arco reads the MCP servers each agent already has and can copy one across the others, so a tool set up in Claude also works in Codex.',
