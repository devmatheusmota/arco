...
export const ptBR: Record<MessageKey, string> = {
  ...
  'todo.dragPosition': 'Reordenar tarefa, posição {position} de {total}',
  ...
  'todo.notes': 'Notas',
  'todo.notesPlaceholder': 'Contexto, critérios de aceite, links — o agente também lê isso.',
  'todo.notesIndicator': 'Tem notas',
  'todo.expand': 'Mostrar detalhes da tarefa',
  'todo.collapse': 'Esconder detalhes da tarefa',
  ...
  'taskSession.forTask': 'Tarefa',
  'taskSession.project': 'Projeto',
  'taskSession.pickProject': 'Selecione um projeto…',
  'taskSession.agent': 'Agente',
  'taskSession.prompt': 'Primeira mensagem',
  'taskSession.promptHint':
    'Enviada ao agente assim que a sessão estiver pronta. Montada a partir do título, das tags e das notas da tarefa.',
  'taskSession.folder': 'Pasta',
  'taskSession.folderPlaceholder': 'A pasta padrão do projeto',
  'taskSession.browse': 'Procurar',
  ...
  'prefs.shortcutRecordLabel': 'Gravar atalho',
  'prefs.shortcutRecording': 'Pressione uma tecla…',
  'prefs.dictationShortcut': 'Atalho',
  'prefs.dictationShortcutDesc': 'Clique e pressione a combinação que quiser. Esc cancela.',
  'prefs.dictationModel': 'Modelo de voz',
  'prefs.dictationModelDesc': 'Roda nesta máquina. Nada é enviado para lugar nenhum.',
  'prefs.modelDownload': 'Baixar',
  'prefs.modelUse': 'Usar',
  'prefs.modelActive': 'Em uso',
  'prefs.modelDeleteActive': 'Selecione outro modelo antes de apagar este.',
  'prefs.modelStreaming': 'streaming',
  'prefs.modelRecommended': 'recomendado',
  'prefs.modelUnsupported':
    'Modelos streaming ainda não são suportados — exigem outro reconhecedor.',
  'prefs.modelDownloading': 'Baixando {file} — {percent}%',
  'prefs.dictationDesc':
  ...
  'whatsNew.v2140.note2':
    'Cada linha de sess\u00e3o diz quando teve atividade pela \u00faltima vez, e o agente \u00e9 marcado por duas letras no lugar de um logo ileg\u00edvel naquele tamanho. O tempo acompanha a sa\u00edda do pr\u00f3prio agente, ent\u00e3o uma sess\u00e3o trabalhando sozinha n\u00e3o parece mais parada. A lista mant\u00e9m a ordem de prop\u00f3sito \u2014 o que se move enquanto voc\u00ea trabalha \u00e9 o que voc\u00ea precisa procurar de novo \u2014 e quem lista as mais recentes primeiro \u00e9 o Find/Jump.',
  'whatsNew.v2140.note3':
    'A marca de \u201cresposta pronta\u201d parou de se acumular. Ela sobrevivia a reinicializa\u00e7\u00f5es, apontando para agentes que morreram com a sess\u00e3o anterior, e visitar um pane limpava s\u00f3 uma das abas enquanto a linha acendia por qualquer uma. Chegar no pane agora limpa o pane, por qualquer caminho \u2014 teclado, Find/Jump e o salto a partir de uma tarefa n\u00e3o limpavam nada antes.',
  'whatsNew.v2140.note4':
    'Novo: um quadro para as suas tarefas, ao lado da Home na barra lateral. Quatro colunas sobre as tarefas que voc\u00ea j\u00e1 tem, e arrastar um cart\u00e3o move a tarefa \u2014 a lista do painel lateral \u00e9 a mesma coisa, n\u00e3o uma c\u00f3pia. Solte uma em Em andamento e o Arco oferece uma sess\u00e3o para ela, com o di\u00e1logo j\u00e1 preenchido a partir da tarefa, a uma tecla de dist\u00e2ncia. Nada come\u00e7a por causa de um arrasto sem querer, e uma tarefa que j\u00e1 tem sess\u00e3o leva voc\u00ea at\u00e9 ela.',
  ...
  'whatsNew.v140.note2':
    'O comando `arco` no terminal abre a pasta atual como projeto — ou foca o app, se já estiver aberto.',
  'whatsNew.v140.note3':
  ...
  'home.quickLaunching': 'Abrindo agente…',
  'home.quickLaunchFailed': 'Não consegui abrir o agente:',
  ...
  'term.openingAgent': 'Abrindo…',
  'term.openAgentFailed': 'Não consegui abrir o agente:',
  ...
  'ui.workspace.openInTab': 'Abrir em aba própria',
  ...
  'ui.imageInput.previewAlt': 'Prévia do ícone',
  ...
  'ui.sidebar.designWorkspaceLayout': 'Desenhar o layout deste projeto',
  ...
  'ws.tabs.close': 'Fechar sessão',
  'ws.tabs.confirmClose': 'Fechar "{name}"? O que estiver rodando nela para.',
  'ws.tabs.openSideTerminal': 'Abrir um terminal ao lado desta sessão',
  'ws.tabs.closeSideTerminal': 'Fechar o terminal ao lado desta sessão',
  ...
  'ws.confirmRemoveForeignAgent': 'O agent "{name}" NÃO foi criado pelo Arco. Remover mesmo assim?',
